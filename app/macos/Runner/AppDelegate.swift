...
class AppDelegate: FlutterAppDelegate {
    ...
    override func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        let yunLanTransferBrandColor = NSColor(red: 0, green: 0.392, blue: 0.353, alpha: 0.8) // #00645a
        DockProgress.style = .squircle(color: yunLanTransferBrandColor)
    ...
    private func setupStatusBarItem(i18n: [String: String]) {
        ...
        if let button = statusItem?.button {
            ...
            let openItem = NSMenuItem(title: openString, action: #selector(showYunLanTransferFromMenuBar), keyEquivalent: "o")
    ...
    @objc func showYunLanTransferFromMenuBar() {
        channel?.invokeMethod("showYunLanTransferFromMenuBar", arguments: nil)
    }
    ...
    func sendPendingItemsToFlutter() {
        ...
        self.showYunLanTransferFromMenuBar()
    }
