...
class _Translations$networkInterfacesPage$et extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Vaikimisi kasutab 云联局域网快传 V1.0 kõiki võrguliideseid. Kui sul on vaja, siis saad mittesoovitud võrgud siinkohal välistada ning muudatuste jõustumine eeldab serverikomponendi uuesti käivitamist.';
  @override
...
class _Translations$receiveOptionsPage$et extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(云联局域网快传 V1.0i kaust)';
  @override
...
class _Translations$webSharePage$et extends Translations$webSharePage$en {
  ...
  String get encryptionHint =>
      '云联局域网快传 V1.0 kasutab enda poolt allkirjastatud sertifikaate. Ühenduse toimimiseks palun nõustu nendega veebibrauseris.';
  @override
...
class _Translations$aboutPage$et extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Rakenduse teave: 云联局域网快传 V1.0';
  @override
  List<String> get description => [
    '云联局域网快传 V1.0 põhineb avatud lähtekoodil, on kõikide jaoks vaba ning tasuta kasutatav. Rakenduse eesmärgiks on võimaldada failide ja tekstide jagamist kohtvõrgus asuvate arvutite vahel nii, et välist internetiühendust pole vaja kasutada.',
  ];
  @override
...
class _Translations$donationPage$et extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      '云联局域网快传 V1.0 põhineb avatud lähtekoodil, on kõikide jaoks vaba ning tasuta kasutatav, ega sisalda reklaame. Kui sulle see rakendus meeldib, siis palun toeta meie arendust.';
  @override
...
class _Translations$tray$et extends Translations$tray$en {
  ...
  @override
  String get close => 'Sulge 云联局域网快传 V1.0';
  @override
...
class _Translations$settingsTab$general$et extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Näita 云联局域网快传 V1.0i kontekstimenüüs';
  @override
...
class _Translations$settingsTab$other$et extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Toeta 云联局域网快传 V1.0i';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$et extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Ilma kohtvõrgu skaneerimise õiguseta ei suuda 云联局域网快传 V1.0 leida teisi seadmeid. Palun luba süsteemi seadistustest vajalikud õigused.';
  @override
...
class _Translations$dialogs$sendModeHelp$et extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link =>
      'Kui failide vastuvõtjatel pole arvutis või nutiseadmes rakendust 云联局域网快传 V1.0, siis avades etteantud lingi oma veebibrauseris, saavad nad failid alla laadida.';
}
