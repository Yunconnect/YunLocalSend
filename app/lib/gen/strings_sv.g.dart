...
class _Translations$networkInterfacesPage$sv extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Som standard använder 云联局域网快传 V1.0 alla tillgängliga nätverksgränssnitt. Du kan utesluta oönskade nätverk här. Starta om servern för att tillämpa ändringarna.';
  @override
...
class _Translations$receiveOptionsPage$sv extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(云联局域网快传 V1.0-mappen)';
  @override
...
class _Translations$webSharePage$sv extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => '云联局域网快传 V1.0 använder ett självsignerat certifikat. Du måste godkänna det i webbläsaren.';
  @override
...
class _Translations$aboutPage$sv extends Translations$aboutPage$en {
  ...
  List<String> get description => [
    '云联局域网快传 V1.0 är en fri app med öppen källkod som gör det möjligt att säkert dela filer och meddelanden med enheter i närheten via det lokala nätverket, utan internetanslutning.',
  ];
  @override
...
class _Translations$donationPage$sv extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      '云联局域网快传 V1.0 är en fri app med öppen källkod och utan annonser. Om du gillar appen kan du stödja utvecklingen genom att donera.';
  @override
...
class _Translations$tray$sv extends Translations$tray$en {
  ...
  @override
  String get close => 'Avsluta 云联局域网快传 V1.0';
  @override
...
class _Translations$settingsTab$general$sv extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Visa 云联局域网快传 V1.0 i snabbmenyn';
  @override
...
class _Translations$settingsTab$other$sv extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Stöd 云联局域网快传 V1.0';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$sv extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      '云联局域网快传 V1.0 kan inte hitta andra enheter utan behörighet att söka i det lokala nätverket. Bevilja behörigheten i inställningarna.';
  @override
...
class _Translations$dialogs$sendModeHelp$sv extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Mottagare som inte har 云联局域网快传 V1.0 installerat kan ladda ner de valda filerna genom att öppna länken i sin webbläsare.';
}
