...
class Translations$networkInterfacesPage$sr extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Podrazumevano, 云联局域网快传 V1.0 koristi sve dostupne mrežne interfejse. Ovde možete izuzeti neželjene mreže. Morate restartovati server da bi se primenile promene.';
  @override
...
class Translations$webSharePage$sr extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => '云联局域网快传 V1.0 koristi samopotpisani sertifikat. Morate ga prihvatiti u svom pregledaču.';
  @override
...
class Translations$aboutPage$sr extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'O 云联局域网快传 V1.0-u';
  @override
  List<String> get description => [
    '云联局域网快传 V1.0 je besplatna aplikacija otvorenog koda koja vam omogućava da bezbedno delite fajlove i poruke sa uređajima u blizini preko vaše lokalne mreže, bez potrebe za internet vezom.',
  ];
  @override
...
class Translations$donationPage$sr extends Translations$donationPage$en {
  ...
  @override
  String get info => '云联局域网快传 V1.0 je besplatan, otvorenog koda i bez ikakvih oglasa. Ako vam se sviđa aplikacija, možete podržati razvoj donacijom.';
  @override
...
class Translations$tray$sr extends Translations$tray$en {
  ...
  @override
  String get close => 'Napusti 云联局域网快传 V1.0';
  @override
...
class Translations$settingsTab$general$sr extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Prikaži 云联局域网快传 V1.0 u kontekstualnom meniju';
  @override
...
class Translations$settingsTab$other$sr extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Podržite 云联局域网快传 V1.0';
  @override
...
class Translations$dialogs$localNetworkUnauthorized$sr extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      '云联局域网快传 V1.0 ne može da pronađe druge uređaje bez dozvole za skeniranje lokalne mreže. Dajte ovu dozvolu u podešavanjima.';
  @override
...
class Translations$dialogs$sendModeHelp$sr extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Primaoci koji nemaju instaliran 云联局域网快传 V1.0 mogu preuzeti izabrane fajlove otvaranjem linka u svom pregledaču.';
}
