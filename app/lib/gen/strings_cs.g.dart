...
class _Translations$networkInterfacesPage$cs extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Ve výchozím nastavení používá 云联局域网快传 všechna dostupná síťová rozhraní. Zde můžete vyloučit nežádoucí sítě. Chcete-li použít změny, musíte restartovat server.';
  @override
...
class _Translations$webSharePage$cs extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => '云联局域网快传 používá self-signed certifikát. Musíte ho přijmout ve vašem prohlížeči.';
  @override
...
class _Translations$aboutPage$cs extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'O aplikaci 云联局域网快传';
  @override
  List<String> get description => [
    '云联局域网快传 je bezplatná aplikace s otevřeným zdrojovým kódem, která vám umožňuje bezpečně sdílet soubory a zprávy s okolními zařízeními přes vaši místní síť, aniž byste potřebovali připojení k internetu.',
  ];
  @override
...
class _Translations$donationPage$cs extends Translations$donationPage$en {
  ...
  @override
  String get info => '云联局域网快传 je zdarma, open source a bez reklam. Pokud se vám aplikace líbí, můžete její vývoj podpořit darem.';
  @override
...
class _Translations$tray$cs extends Translations$tray$en {
  ...
  @override
  String get close => 'Ukončit 云联局域网快传';
  @override
...
class _Translations$settingsTab$general$cs extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Zobrazit 云联局域网快传 v kontextové nabídce';
  @override
...
class _Translations$settingsTab$other$cs extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Podpora 云联局域网快传';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$cs extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      '云联局域网快传 nemůže najít jiná zařízení, aniž by měl oprávnění skenovat místní síť. Udělte prosím toto oprávnění v nastavení.';
  @override
...
class _Translations$dialogs$sendModeHelp$cs extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Příjemci, kteří nemají nainstalovaný 云联局域网快传, si mohou vybrané soubory stáhnout otevřením odkazu ve svém prohlížeči.';
}
