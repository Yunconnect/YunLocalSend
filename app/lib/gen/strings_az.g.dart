...
class _Translations$networkInterfacesPage$az extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Defolt olaraq, 云联局域网快传 V1.0 bütün mövcud şəbəkə interfeyslərindən istifadə edir. Burada istənilməyən şəbəkələri istisna edə bilərsiniz. Dəyişiklikləri tətbiq etmək üçün serveri yenidən başlatmalısınız.';
  @override
...
class _Translations$receiveOptionsPage$az extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(云联局域网快传 V1.0 qovluğu)';
  @override
...
class _Translations$webSharePage$az extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => '云联局域网快传 V1.0 özü imzalanmış sertifikatdan istifadə edir. Siz onu brauzerinizdə qəbul etməlisiniz.';
  @override
...
class _Translations$aboutPage$az extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => '云联局域网快传 V1.0 haqqında';
  @override
  List<String> get description => [
    '云联局域网快传 V1.0 internet bağlantısına ehtiyac olmadan lokal şəbəkə üzərindən yaxınlıqdakı cihazlarla faylları və mesajları təhlükəsiz paylaşmağa imkan verən pulsuz, açıq mənbəli proqramdır.',
  ];
  @override
...
class _Translations$donationPage$az extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      '云联局域网快传 V1.0 pulsuz, açıq mənbəlidir və heç bir reklam yoxdur. Proqramı bəyənirsinizsə, ianə ilə inkişafını dəstəkləyə bilərsiniz.';
  @override
...
class _Translations$tray$az extends Translations$tray$en {
  ...
  @override
  String get close => '云联局域网快传 V1.0-dən çıx';
  @override
...
class _Translations$settingsTab$general$az extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Məzmun menyusunda 云联局域网快传 V1.0-i göstər';
  @override
...
class _Translations$settingsTab$other$az extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => '云联局域网快传 V1.0-i dəstəklə';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$az extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      '云联局域网快传 V1.0 lokal şəbəkəni skan etmək icazəsi olmadan digər cihazları tapa bilmir. Zəhmət olmasa, parametrlərdən bu icazəni verin.';
  @override
...
class _Translations$dialogs$sendModeHelp$az extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => '云联局域网快传 V1.0-i quraşdırmamış alıcılar linki brauzerlərində açaraq seçilmiş faylları endirə bilərlər.';
}
