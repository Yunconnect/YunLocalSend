...
class _Translations$networkInterfacesPage$de extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Standardmäßig verwendet 云联局域网快传 V1.0 alle verfügbaren Netzwerkschnittstellen. Hier können Sie unerwünschte Netzwerke ausschließen. Sie müssen den Server neu starten, um die Änderungen zu übernehmen.';
  @override
...
class _Translations$receiveOptionsPage$de extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(云联局域网快传 V1.0-Ordner)';
  @override
...
class _Translations$webSharePage$de extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => '云联局域网快传 V1.0 verwendet ein selbstsigniertes Zertifikat. Du musst es im Browser akzeptieren.';
  @override
...
class _Translations$aboutPage$de extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Über 云联局域网快传 V1.0';
  @override
  List<String> get description => [
    '云联局域网快传 V1.0 ist eine kostenlose Open-Source-App, mit der du Dateien und Nachrichten sicher über dein lokales Netzwerk mit Geräten in der Nähe teilen kannst, ohne dass eine Internetverbindung erforderlich ist.',
  ];
  @override
...
class _Translations$donationPage$de extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      '云联局域网快传 V1.0 ist kostenlos, quelloffen und frei von Werbung. Wenn dir diese App gefällt, kannst du die Entwicklung mit einer Spende unterstützen.';
  @override
...
class _Translations$tray$de extends Translations$tray$en {
  ...
  @override
  String get close => '云联局域网快传 V1.0 beenden';
  @override
...
class _Translations$settingsTab$general$de extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => '云联局域网快传 V1.0 im Kontextmenü anzeigen';
  @override
...
class _Translations$settingsTab$other$de extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => '云联局域网快传 V1.0 unterstützen';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$de extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      '云联局域网快传 V1.0 kann nicht auf das lokale Netzwerk zugreifen. Bitte erlaube 云联局域网快传 V1.0 den Zugriff auf das lokale Netzwerk in den Einstellungen.';
  @override
...
class _Translations$dialogs$sendModeHelp$de extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link =>
      'Empfänger, die 云联局域网快传 V1.0 nicht installiert haben, können die ausgewählten Dateien herunterladen, in dem sie den Link im Browser öffnen.';
}
